...
namespace libsndfile.NET8
{
    public sealed partial class SndFile : IDisposable
    {
        ...
        /// </returns>
        public static unsafe string GetErrorMessage(SndFile? sndFile = null)
        {
        ...
        public unsafe void SetString(SfString @string, string? value)
        {
        ...
        [DllImport("libsndfile-1", CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe IntPtr sf_strerror(SndFile__* sndFile);
