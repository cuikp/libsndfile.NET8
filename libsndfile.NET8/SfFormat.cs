...
namespace libsndfile.NET8
{
    ...
    public struct SfFormat
    {
        ...
        /// <summary>
        ///     Default Mp3 format: 2 channels, 44.1Khz, mpeg layer III
        /// </summary>
        public static SfFormat DefaultMp3 { get; } =
            new SfFormat(SfFormatMajor.MPEG, SfFormatSubtype.MPEG_LAYER_III, SfFormatEndian.FILE, 2, 44100);
